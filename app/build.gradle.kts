...
android {
    namespace = "com.texter.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.texter.app"
        minSdk = 26
        targetSdk = 35
    ...
    buildTypes {
        release {
            ...
            // and local builds actually ship, so it needs the same pinned key for update
            // checkers (Obtainium) and Android itself to accept it as an in-place update rather
            // than a signature conflict.
